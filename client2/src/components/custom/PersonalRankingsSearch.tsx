    ...
    <div class="mb-2 flex w-full flex-col items-center gap-2">
      <div class="relative w-full max-w-md">
        ...
        >
          ...
          <Search.Portal>
            <Search.Content
              class="absolute z-50 mt-2 w-full rounded-md border bg-popover text-popover-foreground shadow-lg no-scrollbar animate-in fade-in-0 zoom-in-95"
              style={{
            ...
            >
              ...
              <Show when={isSearching() && searchResults().length === 0}>
                <div class="py-6 text-center text-sm text-muted-foreground flex items-center justify-center gap-2">
      ...
      <Show when={props.selectedPerson}>
        {(person) => (
          <a
            ...
            class="mt-2"
          >
            <Button variant="outline" class="font-normal h-9">
              <WCALogo class="h-4 w-4 me-2" />
              View WCA Profile
            </Button>
          </a>
        )}
